...
<body>
 ...
 %>
							<a href="GroupServlet?joincom=y"
							class="waves-effect waves-light btn black">Join</a>
						</span>
						<%
							}
						%>
						<%
							if ((String) request.getAttribute("iscom") != "isnot") {
						%>
						<a href="GroupServlet?joincom=n"
							class="waves-effect waves-light btn black">Leave</a></span>
						<%
							}
						%>
					</div>
						...
						<div class="card-content black-text info">
							...
							<a href="ComradeServlet?ComradeAdd=<%out.println(name);%>">
								<%
									out.println(name);
								%>
							</a><br> <a href="GroupServlet?Expel=<%out.println(name);%>">${expel}</a><br>
							<%
								}
							%>
						</div>
			...
			<div class="col s12 m8 offset-m1">
				<div class="card white">
					<div class="card-content">
						...
						<form class="container" action="GroupServlet" method="GET">
							${notMember}
							<div class="row">
				...
				<div class="row">
					...
					if (post.get("poster").equals(((Comrade)request.getSession().getAttribute("sharedCom")).getUserName()) || request.getSession().getAttribute("admin").equals(((Comrade)request.getSession().getAttribute("sharedCom")).getUserName())){ %>
					<a href="GroupServlet?deletePost=y&indexd=<%out.println(post.get("cont"));%>"><i class = "material-icons small">close</i></a>
					<%} %>
 ...
 %>
								...
								href="GroupServlet?like=y&indexl=<%out.println(post.get("cont"));%>"><i
						...
						<ul id="collapsa2" class="collapsible"
							...
							<li>
								...
								<div class="collapsible-body">
									<div class="card-content">
										<form class="container" action="GroupServlet" method="POST">
											<div class="input-field col s12 m6">
